    ...
    <section className="space-y-6 container mx-auto py-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Button
          ...
          className="w-full sm:w-auto rounded-full bg-emerald-600 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 dark:focus:ring-offset-zinc-950"
        >
          <Plus className="h-4 w-4 mr-2" />
          New Task
        </Button>
      ...
      <KanbanBoard
        ...
        onMove={moveTask}
        renderColumn={(status) =>
          grouped[status].map((task: Task, idx) => (
            <TaskCard
